        ...
        <div className="grid md:grid-cols-2 gap-8 auto-rows-fr">
          {desafios.map((item, index) => (
            <AnimatedItem key={index} delay={index * 0.1}>
              <div 
                className="bg-white p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 h-full flex flex-col relative overflow-hidden cursor-pointer"
              ...
              >
                ...
                <div className="flex-grow relative z-10">
                  <item.icon className={`w-12 h-12 mb-4 transition-colors duration-300 ${
